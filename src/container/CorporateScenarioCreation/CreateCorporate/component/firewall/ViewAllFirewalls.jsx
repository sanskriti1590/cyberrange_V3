...
const ViewAllFirewalls = ({ handleClick, firewalls = [], DelIns, load, onEdit }) => {
    ...
    const handleEdit = (id) => {
        onEdit(id); // Callback to parent for editing
        handleCloseMenu();
    };
    ...
    return (
        <Stack margin={5} gap={4}>
                ...
                {firewalls.map((data, index) => (
                    ...
                    >
                        <Stack direction="row" justifyContent="space-between">
                            <Stack gap={2} direction="row">
                                <Typography color="#b46228 !important">IP Address:</Typography>
                        ...
                        <Typography variant="body1">{data.instance_name || "Unnamed"}</Typography>
            ...
            <Button
                variant="contained"
                color="secondary"
                style={{ width: "150px", textWrap: "nowrap" }}
                disabled={!but}
...
ViewAllFirewalls.propTypes = {
    ...
    onEdit: PropTypes.func, // new edit handler
    load: PropTypes.bool,
};
